...
export default function Login() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      setErr(e.message || "Failed to login. Please try again.");
    }
  }
      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700">
          <div className="text-center mb-6">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mb-2">Welcome Back</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link to="/register" className="text-blue-600 dark:text-sky-400 font-semibold hover:underline">
                Sign up
              </Link>
            </p>
          </div>
