...
export default function EditDestination() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await localApi.updateDestination(id, payload);
      navigate("/");
    } catch (error) {
  ...
  if (!form) return <div className="p-6 text-center text-red-600">Not found</div>;
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 p-6 sm:p-8">
        <h2 className="text-2xl sm:text-3xl font-extrabold mb-2 text-slate-900 dark:text-white">Edit Destination</h2>
        <p className="text-slate-600 dark:text-slate-400 mb-6">Update destination information</p>
